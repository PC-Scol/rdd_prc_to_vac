...
## --------------------------------------------
# ETAPE 3 1  : generation des cl�s lccs
# --------------------------------------------
...
echo -e "  >>>   Debut du traitement du fichier  cl�e des LCCs " >> $FIC_LOG

# recherche des cl�s lcc pour la demande
sqlplus -s <<FIN_SQL 
${STR_CONX}
...
echo -e "  >>>   Fin du traitement de la g�n�ration cl� des LCCs" >> $FIC_LOG
...
echo 'code objet formation cible;code objet formation source;actif O/N;commentaire (2000 caractères max.)' > ${DIR_FIC_SORTIE}/${FIC_NAME_APOGEE_LCC}
...
echo -e "  >>>   Fin du traitement de la g�n�ration des LCCs" >> $FIC_LOG
